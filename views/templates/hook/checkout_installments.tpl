<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function createInstallmentContainer(amount) {
            ...
            let summaryTotalElement = document.querySelector('.cart-summary-line.cart-total');
            ...
            if (summaryTotalElement) {
                ...
                summaryTotalElement.parentNode.insertBefore(installmentsButton, summaryTotalElement.nextSibling);
            }
        }
        ...
        function observePaymentMethodChanges() {
            const paymentOptionsElement = document.querySelector('.payment-options');
            if (paymentOptionsElement) {
                ...
                observer.observe(paymentOptionsElement, {
                    childList: true,
                    attributes: true,
                    subtree: true
                });
