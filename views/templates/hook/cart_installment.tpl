<script>
    document.addEventListener('DOMContentLoaded', function () {
        function createInstallmentsButton() {
            let cartValueElement = document.querySelector('.cart-summary-line.cart-total .value');
            let valueText = cartValueElement.textContent || cartValueElement.innerText;
        ...
        function createInstallmentContainer(amount) {
            ...
            if (checkoutButton && !document.querySelector('.installments-button')) {
                ...
                checkoutButton.parentNode.insertBefore(installmentsButton, checkoutButton);
            }
        }

        createInstallmentsButton();

        function onCartValueChanged() {
            createInstallmentsButton()
        }
        ...
        function observeCartChanges() {
            ...
            if (cartSummaryElement) {
                ...
                observer.observe(cartSummaryElement, {
                    childList: true,
                    attributes: true,
                    subtree: true
                });
