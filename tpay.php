...
class Tpay extends PaymentModule
{
    ...
    public function hookDisplayOrderConfirmation($params): string
    {
        ...
        if ($transaction && $transaction['transaction_id'] && $this->isTransferOrCardPayment($transaction)) {
            $this->initAPI();
    ...
    {
        return 'blik' === $transaction['payment_type'] || 'renew-payment' == Tools::getValue('action');
    }
